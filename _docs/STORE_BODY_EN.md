...
- **Hand-tuned EMC** for the root resources — metals, gems (fluorite, tourmaline), mana resources, worldgen plants, and crystals.
...
All Rights Reserved (free to put in any modpack, no permission or credit needed). Magitech is by Stln; ProjectE by sinkillerj & contributors. This is an independent integration, not affiliated with either. Source: https://github.com/KURONAMI333/magitech-emc
